...
function generateAvatar(username) {
    ...
    const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100">
        ...
        <text x="50" y="65" font-size="45" text-anchor="middle" fill="white" font-family="system-ui, sans-serif" font-weight="600">${initial}</text>
    </svg>`;
...
module.exports = { slugify, generateAvatar, timeAgo, escapeHtml, iconSvg };

// Inline SVG icons (feather-style) for category icons
const ICON_PATHS = {
...
function iconSvg(name, size = 22) {
    const path = ICON_PATHS[name] || ICON_PATHS['message-circle'];
